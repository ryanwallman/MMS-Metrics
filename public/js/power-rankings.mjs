...
// lib/regularSeasonSchedule.js
var require_regularSeasonSchedule = __commonJS({
  "lib/regularSeasonSchedule.js"(exports, module) {
    "use strict";
    var REGULAR_SEASON_GAMES = 22;
    function safeText(value) {
      return (value || "").toString().trim();
...
var require_powerRankingsVizData = __commonJS({
  "lib/powerRankingsVizData.js"(exports, module) {
    ...
    var { isRegularSeasonScheduleGame } = require_regularSeasonSchedule();
    ...
    function buildWeeklyPowerHistory(schedulePayload, teams, leagueRows) {
      ...
      for (let i = 0; i < options.length; i += 1) {
        ...
        const playedGames = parsedGames.filter(
          (g) => isRegularSeasonScheduleGame(g) && isPlayedScheduleGame(g) && safeText(g.isoDate) <= cutoffIso
        );
...
var require_powerRankingsPageData = __commonJS({
  "lib/powerRankingsPageData.js"(exports, module) {
    ...
    var { filterRegularSeasonScheduleGames } = require_regularSeasonSchedule();
    function toNumber(value) {
      const n = Number(value);
      return Number.isFinite(n) ? n : 0;
    }
    ...
    async function buildPowerRankingsPageData2() {
      ...
      const parsedScheduleGames = schedulePayload.parsedGames || [];
      const regularSeasonGames = filterRegularSeasonScheduleGames(parsedScheduleGames);
      const referenceIso = defaultScheduleReferenceIso();
      const pastPlayedGames = filterPastPlayedScheduleGames(regularSeasonGames, referenceIso);

...
var require_matchupPredict = __commonJS({
  "lib/matchupPredict.js"(exports, module) {
    ...
    var MATCHUP_WIN_WEIGHT_FROM_RUNS = 0.7;
    var MATCHUP_WIN_WEIGHT_FROM_TALENT = 0.2;
    var MATCHUP_WIN_WEIGHT_FROM_RECORD = 0.1;
    ...
    var MATCHUP_POWER_WEIGHT_OFFENSE = 0.38;
    var MATCHUP_POWER_WEIGHT_RUN_PROD = 0.13;
    var MATCHUP_POWER_WEIGHT_RUNS_FOR = 0.11;
    var MATCHUP_POWER_WEIGHT_RUNS_AGAINST = 0.09;
    var MATCHUP_POWER_WEIGHT_TEAM_OVERALL = 0.24;
    ...
    function teamCompositePower(profile, norms, isHome) {
      ...
      let power = MATCHUP_POWER_WEIGHT_OFFENSE * zOff + MATCHUP_POWER_WEIGHT_RUN_PROD * zRun + MATCHUP_POWER_WEIGHT_RUNS_FOR * zRf + MATCHUP_POWER_WEIGHT_RUNS_AGAINST * zRa + MATCHUP_POWER_WEIGHT_TEAM_OVERALL * zTeam + MATCHUP_POWER_WEIGHT_SOS * zSos;
      if (isHome) power += MATCHUP_HOME_FIELD_LOGIT / MATCHUP_LOGIT_SCALE;
      return {
        power,
        components: { zOff, zRun, zRf, zRa, zTeam, zSos }
      };
    }
    ...
    function predictMatchupGame(awayProfile, homeProfile, norms, runBase) {
      ...
      const pHomeRaw = MATCHUP_WIN_WEIGHT_FROM_RUNS * winFromRuns.home + MATCHUP_WIN_WEIGHT_FROM_TALENT * winFromTalent.home + MATCHUP_WIN_WEIGHT_FROM_RECORD * winFromRecord.home;
...
// lib/playoffBracket.js
var require_playoffBracket = __commonJS({
  "lib/playoffBracket.js"(exports, module) {
    "use strict";
    var PLAYOFF_TEAM_COUNT = 18;
    var DIRECT_PLAYOFF_SEEDS = 14;
...
// lib/powerRankingsVizData.js
var require_powerRankingsVizData = __commonJS({
  "lib/powerRankingsVizData.js"(exports, module) {
    "use strict";
    var { normalizePlayerName } = require_dfs();
    var { normalizeScheduleTeamId } = require_teamRosters();
    var { isPlayedScheduleGame } = require_powerRankingsCore();
    var { heatMapBackground } = require_powerRankingsCore();
    var {
      buildTeamStandingsFromScheduleGames,
      buildTeamOffenseSections
    ...
    function buildWeeklyPowerHistory(schedulePayload, teams, leagueRows) {
      ...
      for (let i = 0; i < options.length; i += 1) {
        ...
        const playedGames = parsedGames.filter(
          (g) => isPlayedScheduleGame(g) && safeText(g.isoDate) <= cutoffIso
        );
...
// lib/powerRankingsPageData.js
var require_powerRankingsPageData = __commonJS({
  "lib/powerRankingsPageData.js"(exports, module) {
    var { normalizePlayerName } = require_dfs();
    var { loadTeamRosters, normalizeScheduleTeamId } = require_teamRosters();
    var { SCHEDULE_URL } = require_sheetUrls();
    var { load2026StatsByPlayer } = require_stats2026Loader();
    var { loadPowerRankingsCaptainMap } = require_powerRankingsCaptains();
    var {
      loadCareerByPlayer,
      load2025HistoricalByPlayer,
      buildParsedScheduleGames,
    ...
    var { buildPowerRankingsVizData } = require_powerRankingsVizData();
    function toNumber(value) {
      const n = Number(value);
      return Number.isFinite(n) ? n : 0;
    }
    ...
    async function buildPowerRankingsPageData2() {
      const [
        teams,
        careerByPlayer,
        hist2025ByPlayer,
    ...
    module.exports = {
      buildPowerRankingsPageData: buildPowerRankingsPageData2,
      REGULAR_SEASON_GAMES
    };
  }
});

// client/power-rankings-entry.mjs
var import_powerRankingsPageData = __toESM(require_powerRankingsPageData(), 1);
async function fetchPowerRankingsData() {
  return (0, import_powerRankingsPageData.buildPowerRankingsPageData)();
}
if (typeof window !== "undefined") {
  window.MmsPowerRankings = { fetchPowerRankingsData };
}
export {
  fetchPowerRankingsData
};

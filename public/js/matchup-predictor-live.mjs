...
var require_dfs = __commonJS({
  "lib/dfs.js"(exports, module) {
    ...
    var { getGamelogs2026CsvUrl: getGamelogs2026CsvUrl2 } = require_sheetUrls();
...
${slice[1]}`;
    ...
    async function load2026GamelogsByPlayer2() {
      try {
        let text = await fetchCsvText(getGamelogs2026CsvUrl2());
...
var require_dfsLeaderboardScoringContext = __commonJS({
  "lib/dfsLeaderboardScoringContext.js"(exports, module) {
    ...
    async function loadWeeklySchedule2() {
      const [scheduleRows, teams] = await Promise.all([fetchCsvRows(SCHEDULE_URL2), loadTeamRosters2()]);
...
async function refreshLiveGamelogMissing(ctx = window.__MATCHUP_CLIENT__) {
  ...
  import_fetchCsvText.csvTextCache.invalidate(import_sheetUrls.SCHEDULE_URL);
  import_fetchCsvText.csvTextCache.invalidate((0, import_sheetUrls.getGamelogs2026CsvUrl)());

...
var require_leagueLeaders = __commonJS({
  "lib/leagueLeaders.js"(exports, module) {
    ...
    function isTruthyRookie(value) {
      const text = safeText2(value).toLowerCase();
...
var require_playerHistoricalStats = __commonJS({
  "lib/playerHistoricalStats.js"(exports, module) {
    ...
    function headerIndex(headers, candidates) {
      const lower = headers.map((h) => safeText2(h).toLowerCase());
...
var require_sitePaths = __commonJS({
  "lib/sitePaths.js"(exports, module) {
    ...
    function sitePath2(path, basePath = "") {
    ...
    function mapNavHrefs(navItems, basePath) {
      return (navItems || []).map((item) => ({
        ...item,
        href: sitePath2(item.href, basePath),
        subnav: (item.subnav || []).map((sub) => ({
          ...sub,
          href: sitePath2(sub.href, basePath)
        }))
      }));
    }
    module.exports = {
...
var require_matchupPredictorMode = __commonJS({
  "lib/matchupPredictorMode.js"(exports, module) {
    ...
    function matchupPredictorBasePath(mode, basePath = "") {
      ...
      return sitePath2(`/matchup-predictor/${m}`, basePath);
    }
...
var require_matchupPredictorStaticNav = __commonJS({
  "lib/matchupPredictorStaticNav.js"(exports, module) {
    ...
    async function staticMatchupPageExists(routePath, basePath = "") {
      const url = sitePath2(routePath, basePath);
      try {
    ...
    function viewTokenFromPathname2(pathname) {
...
async function resolveNavigateTarget(mode, view) {
  ...
  if ((0, import_matchupPredictorStaticNav.isStaticMatchupHost)()) {
    return (0, import_matchupPredictorStaticNav.resolveStaticMatchupNavigateUrl)({ mode, view, basePath });
  }

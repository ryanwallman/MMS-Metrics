...
var require_matchupWinProbCalibration = __commonJS({
  "lib/matchupWinProbCalibration.js"(exports, module) {
    ...
    function applyWinProbCalibration2(awayProfile, homeProfile, prediction, weights) {
      ...
      return alignProjectedRunsToWinFavorite(enrichMatchupPredictionLines2(adjusted));
    }
    function calibratedMatchupWinProbs(awayProfile, homeProfile, leagueNorms, runBase, weights) {
      ...
      if (weights?.length) {
        prediction = applyWinProbCalibration2(awayProfile, homeProfile, prediction, weights);
      }
      return {
    ...
    module.exports = {
      ...
      applyWinProbCalibration: applyWinProbCalibration2,
...
var import_matchupWinProbCalibration = __toESM(require_matchupWinProbCalibration(), 1);
...
function predictFromPayload(ctx, awayMissingList, homeMissingList) {
  ...
  if (!ctx.isFinishedGame && ctx.calibrationWeights?.length) {
    prediction = (0, import_matchupWinProbCalibration.applyWinProbCalibration)(
      awayProfile,
      homeProfile,
      prediction,

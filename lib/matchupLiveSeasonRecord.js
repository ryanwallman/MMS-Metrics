...
const { isPastPlayedScheduleGame, defaultScheduleReferenceIso } = require("./powerRankingsCore");
...
const { getCachedPlayerReplacements, refreshLivePlayerReplacements } = require("./playerReplacements");
...
function countFinishedScheduleGames(parsedGames, referenceIso) {
...
async function gatherMatchupSeasonRecordDeps(opts = {}) {
  const replacementsPromise = opts.refreshReplacements

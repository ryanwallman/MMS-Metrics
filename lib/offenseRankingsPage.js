...
/** All-time stats (live sheet); hist2025 retained for call-site compatibility only. */
...
function buildOffenseRatingForNorm(
  norm,
  careerByPlayer,
  hist2025ByPlayer,
  stats2026ByPlayer,
...
/** Add POR entries for replacement players (career → 2025 → 2026), keyed by replacementNorm. */
function extendOffenseRatingsForReplacements(
  offenseRatingByNorm,
  byOriginalNorm,
  careerByPlayer,
  hist2025ByPlayer,

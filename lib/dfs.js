...
/** Offense ratings within this span share one salary on a slate. */
const DFS_OFFENSE_RATING_BAND = 0.15;
/** Bottom share of the slate pool pinned to DFS_SALARY_MIN (no single “cheapest” player). */
const DFS_BOTTOM_TIER_PCT = 0.25;
...
/**
 * Pin the lowest 25% of the slate (by raw salary) to DFS_SALARY_MIN.
...
/** Sunday week slates: lock 11:59 PM ET the night before games. Wednesday: lock 5:00 PM ET on game day. */
 ...
 * Sunday slates lock 11:59 PM ET the night before games; Wednesday slates lock 5:00 PM ET on game day.
 */

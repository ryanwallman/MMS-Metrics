...
/** How strongly benching above/below team average moves projected strength. */
const BENCH_VS_AVG_SENSITIVITY = 1.22;
...
function applyMissingPlayersToProfile(
  ...
  const rosterTeam =
    baseTeam != null && Number.isFinite(baseTeam) && anchorOff > 0
      ? baseTeam * (rosterOff / anchorOff)
      : baseTeam;
  const adjustedTeamOverall =
    rosterTeam != null && Number.isFinite(rosterTeam) ? rosterTeam * teamMult.offense : rosterTeam;

...
/** Win % blend: projected runs, composite talent, and regressed record. */
...
/** Composite team strength weights (sum = 1; record is a separate win-% input). */
const MATCHUP_POWER_WEIGHT_OFFENSE = 0.38;
const MATCHUP_POWER_WEIGHT_RUN_PROD = 0.13;
const MATCHUP_POWER_WEIGHT_RUNS_FOR = 0.11;
const MATCHUP_POWER_WEIGHT_RUNS_AGAINST = 0.09;
const MATCHUP_POWER_WEIGHT_TEAM_OVERALL = 0.24;

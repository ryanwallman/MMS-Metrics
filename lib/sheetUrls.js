/**
 * Published Google Sheet CSV URLs for live league data (browser + server).
 * These are the same exports maintained for marlborosoftball.com (schedule, stats, rosters, etc.).
...
/** Mid-season roster replacements (Original Player → New Player). */
const REPLACEMENTS_SHEET_ID = "1aYG02LsmBEpZCQap-f81YyEjTaR6a8asPlzNe0n31b0";
const REPLACEMENTS_GID = "0";
